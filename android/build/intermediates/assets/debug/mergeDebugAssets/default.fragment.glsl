...
{
    const vec4 bitShifts = vec4(101.0, 101.0 / 255.0, 101.0 / 65025.0, 101.0 / 16581375.0);
    return step(v_shadowMapUv.z, dot(texture2D(u_shadowTexture, v_shadowMapUv.xy + offset), bitShifts));//+(101.0/255.0));
}
