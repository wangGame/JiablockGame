 ...
 * Signature: ([F[FIII)V
 */
JNIEXPORT void JNICALL Java_com_badlogic_gdx_math_Matrix4_mulVec
 ...
 * Signature: ([F[FIII)V
 */
JNIEXPORT void JNICALL Java_com_badlogic_gdx_math_Matrix4_prj
  (JNIEnv *, jclass, jfloatArray, jfloatArray, jint, jint, jint);
 ...
 * Signature: ([F[FIII)V
 */
JNIEXPORT void JNICALL Java_com_badlogic_gdx_math_Matrix4_rot
  (JNIEnv *, jclass, jfloatArray, jfloatArray, jint, jint, jint);
